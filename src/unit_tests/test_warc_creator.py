...
class TestWarcCreator(unittest.TestCase):
    ...
    def test_create_article_warc(self):
        ...
        self.assertTrue(os.path.isfile(WARC_ARTICLE_DIRECTORY + \
            "/http:__www.cbc.ca_news_world_nor-easter-storm-blasts-eastern" + \
            "-u-s-with-heavy-rain-and-snow-1.2851711.warc.gz") )
    ...
    def test_create_twitter_warc(self):
        ...
        try:
            ...
            os.remove(WARC_TWITTER_DIRECTORY + \
                "/https:__twitter.com_wesbos_status_519123918422958081.warc.gz")
        except OSError:
            pass   
        self.setUp()
    ...
    def test_create_wrong_url_twitter_warc(self):
        """
        crawling a wrong twitter article should be going to success because there 
        is 404 page
        """
        try:
            os.chdir("..")
