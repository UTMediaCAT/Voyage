...
class ExplorerArticleJsonIssue(object):#derive from object for getters/setters
    ...
    def get_links_crawl(self, article_text_links_only=False):
        ...
        try:
            ...
            print(self.url)
            child = sp.Popen(["node", "../javascript_crawler_script/crawl_json_parse_issue.js", "-l", self.url], stdout=sp.PIPE)
            ...
            try:
                ...
                with open("../javascript_crawler_script/link_title_list_json_issue.json", encoding='utf-8') as result_file:
                    logging.info("reading")
                    json_data = json.loads(result_file.read())
                    res = json_data
                    logging.info("reading done")
