...
def create_warc(url, dir):
    ...
    # create png file
    subprocess.check_call()(["phantomjs", "rasterize.js", rename_url,  url +".png"], cwd="../"+dir )
    # create pdf file
    subprocess.check_call()(["phantomjs", "rasterize.js", rename_url,  url + ".pdf"], cwd="../"+dir )

    subprocess.Popen(["tar", "cvzf", url + ".tar", url +".png", url + ".pdf"], cwd="../"+dir)
