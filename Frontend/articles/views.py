...
def getWarc(request, filename):
    ...
    filename_ext = path + "/" + filename + ".warc"
    ...
    if u'WebKit' in request.META['HTTP_USER_AGENT']:
        ...
        filename_header = 'filename=%s' % (filename + ".warc").encode('utf-8')
        ...
        filename_header = 'filename*=UTF-8\'\'%s' % urllib.quote((filename + ".warc").encode('utf-8'))
